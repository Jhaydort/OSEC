...
export const seoPages: PageMetadata[] = [
  ...
  { path: '/news-health-articles', title: 'News & Health Articles | OSEC', description: 'OSEC health articles are not yet available. Contact the clinic for information about services.', noindex: true },
